export default function PiePagina() {
  return (
    <div className="container-fluid bg-primary text-white mt-5 py-4">
      <div className="row text-center justify-content-center">
        {/* Resumen */}
        <div className="col-lg-3 col-md-6 mb-5 text-start">
          <h4 className="text-uppercase mb-4">Resumen</h4>
      ...
      <div className="text-center mt-1 py-1">
        <p className="mb-2">© 2024 JAB Coloreando tu Vida. Todos los derechos reservados.</p>
